...
allPokemon = {'xiaolada': PokeLevel.D, 'bobo': PokeLevel.D, 'lvmaochong': PokeLevel.D, 'dujiaochong': PokeLevel.D,
              'xiaoladae': PokeLevel.D, 'guisi': PokeLevel.D,
              ...
              'maoqiu': PokeLevel.C, 'liuwei': PokeLevel.C, 'miaomiaoe': PokeLevel.C, 'heianya': PokeLevel.C,
              'chounie': PokeLevel.C,
              ...
              'feitiantanglang': PokeLevel.B, 'dajia': PokeLevel.B, 'mengyao': PokeLevel.B, 'dailubi': PokeLevel.B,
              'guisitong': PokeLevel.B,
              ...
              'shandianniao': PokeLevel.S, 'chaomeng': PokeLevel.S, 'banjila': PokeLevel.S, 'genggui': PokeLevel.S,
              'xuelabi': PokeLevel.S}
...
pokeNameEng = ['xiaolada', 'bobo', 'miaomiao', 'wasidan', 'apashe',
              ...
              ['xiaoladae', 'guisi', 'miaomiaoe', 'heianya', 'chounie',
